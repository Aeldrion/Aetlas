...
data modify storage aetlas:traceback Score append value 0
execute store result storage aetlas:traceback Score[-1] run scoreboard players get $aetlas.condition_passed aetlas.var
...
execute if score $aetlas.conditions aetlas.var matches 1.. if score $aetlas.condition_passed aetlas.var matches 1 run function aetlas:structures/table/evaluate_all_conditions
