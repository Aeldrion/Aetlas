...
execute if score $aetlas.location_has_offset aetlas.var matches 1 as @e[type=minecraft:area_effect_cloud, tag=aetlas.location_check.offset, limit=1] run function aetlas:structures/table/condition/location_check/apply_offset
execute if score $aetlas.location_has_offset aetlas.var matches 1 at @e[type=minecraft:area_effect_cloud, tag=aetlas.location_check.offset, limit=1] run function aetlas:structures/table/condition/location_check/check_predicate
...
execute unless score $aetlas.location_has_offset aetlas.var matches 1 run function aetlas:structures/table/condition/location_check/check_predicate
