...
execute store result storage aetlas:traceback Score[-1] run scoreboard players get $aetlas.weight_index aetlas.var
data modify storage aetlas:traceback Score append value 0
execute store result storage aetlas:traceback Score[-1] run scoreboard players get $aetlas.weight_sum aetlas.var
...
function aetlas:structures/table/pool/get_entry_at_weight_index
function aetlas:structures/table/entry/read_entry
