...
data modify storage aetlas:traceback Score append value 0
execute store result storage aetlas:traceback Score[-1] run scoreboard players get $aetlas.total_weight aetlas.var
...
function aetlas:structures/table/pool/filter_entries
...
data modify storage aetlas:traceback Entries append from storage aetlas:traceback Pool[-1]."entries"
execute store result score $aetlas.entries aetlas.var run data get storage aetlas:traceback Entries[-1]
scoreboard players set $aetlas.total_weight 0
function aetlas:structures/table/pool/determine_total_weight
data remove storage aetlas:traceback Entries[-1]
...
execute if data storage aetlas:traceback Pool[-1]."rolls" unless data storage aetlas:traceback Pool[-1]."rolls"."min" store result score $aetlas.rolls aetlas.var run data get storage aetlas:traceback Pool[-1]."rolls"
execute if data storage aetlas:traceback Pool[-1]."rolls"."min" store result score $aetlas.random.min aetlas.var run data get storage aetlas:traceback Pool[-1]."rolls"."min"
execute if data storage aetlas:traceback Pool[-1]."rolls"."min" store result score $aetlas.random.max aetlas.var run data get storage aetlas:traceback Pool[-1]."rolls"."max"
execute if data storage aetlas:traceback Pool[-1]."rolls"."min" run scoreboard players add $aetlas.random.max aetlas.var 1
execute if data storage aetlas:traceback Pool[-1]."rolls"."min" run function aetlas:math/random_range
execute if data storage aetlas:traceback Pool[-1]."rolls"."min" run scoreboard players operation $aetlas.rolls aetlas.var = $aetlas.random aetlas.var

# Call random entries unless there are no entries left
data modify storage aetlas:traceback Entries append from storage aetlas:traceback Pool[-1]."entries"
execute store result score $aetlas.entries aetlas.var run data get storage aetlas:traceback Entries[-1]
execute if score $aetlas.entries aetlas.var matches 1.. function aetlas:structures/table/pool/dice_rolls
data remove storage aetlas:traceback Entries[-1]
