...
execute store result storage aetlas:traceback Score[-1] run scoreboard players get $aetlas.weight aetlas.var

# Get entry's weight
data modify storage aetlas:traceback Entry append from storage aetlas:traceback Entries[-1][0]
function aetlas:structures/table/entry/get_weight
...
execute if score $aetlas.entries aetlas.var matches 1.. run function aetlas:structures/table/pool/determine_total_weight
