...
execute if score $aetlas.entries aetlas.var matches 1.. unless score $aetlas.conditions_passed aetlas.var matches 1 run function aetlas:structures/table/entry/read_all_entries_until_conditions_pass
