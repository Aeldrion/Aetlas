...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/structure_table
...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/structure_reference
...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/structure
...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/alternatives
...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/group
...
execute if score $aetlas.entry_type aetlas.var matches 0 run function aetlas:structures/table/entry/sequence
