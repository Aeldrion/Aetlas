...
execute if predicate aetlas:dimension/overworld run scoreboard players set $surface_height aetlas 255
...
execute if predicate aetlas:dimension/the_nether run scoreboard players set $surface_height aetlas 0
...
execute if predicate aetlas:dimension/the_end run scoreboard players set $surface_height aetlas 128
