...
execute if score $aetlas.conditions_passed aetlas.var matches 1 run data modify storage aetlas:traceback NewEntries[-1] append from storage aetlas:traceback Entry[-1]
