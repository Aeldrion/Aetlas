...
execute unless data storage aetlas:private ConditionParameters.predicate.position.x.max unless data storage aetlas:private ConditionParameters.predicate.position.x.max store result score $aetlas.pos.y.min aetlas.var store result score $aetlas.pos.y.max aetlas.var run data get storage aetlas:private ConditionParameters.predicate.position.x
execute if data storage aetlas:private ConditionParameters.predicate.position.x.max store result score $aetlas.pos.y.min aetlas.var run data get storage aetlas:private ConditionParameters.predicate.position.x.max
