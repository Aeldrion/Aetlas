...
execute if data storage aetlas:private ConditionParameters.predicate.position.x.max store result score $aetlas.pos.x.min aetlas.var run data get storage aetlas:private ConditionParameters.predicate.position.x.max
