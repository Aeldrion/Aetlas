...
execute unless data storage aetlas:private ConditionParameters."predicate"."position"."x"."min" unless data storage aetlas:private ConditionParameters."predicate"."position"."x"."max" store result score $aetlas.pos.z.min aetlas.var store result score $aetlas.pos.z.max aetlas.var run data get storage aetlas:private ConditionParameters."predicate"."position"."x"
execute if data storage aetlas:private ConditionParameters."predicate"."position"."x"."min" store result score $aetlas.pos.z.min aetlas.var run data get storage aetlas:private ConditionParameters."predicate"."position"."x"."min"
