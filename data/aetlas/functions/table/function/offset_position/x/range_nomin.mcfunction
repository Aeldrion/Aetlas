...
execute store result score $aetlas.upper_bound aetlas.var run data get storage aetlas:private Function."x"."max"
...
execute if score $aetlas.upper_bound aetlas.var matches 0.. run scoreboard players operation $aetlas.pos.dx aetlas.var += $aetlas.random aetlas.var

# If no lower bound is specified and the upper bound is negative, the offset is set to the specified upper bound
execute if score $aetlas.upper_bound aetlas.var matches ..-1 run scoreboard players operation $aetlas.pos.dx aetlas.var += $aetlas.upper_bound aetlas.var