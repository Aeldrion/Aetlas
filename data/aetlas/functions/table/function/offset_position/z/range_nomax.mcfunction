...
execute store result score $aetlas.lower_bound aetlas.var run data get storage aetlas:private Function.z.max
...
execute if score $aetlas.lower_bound aetlas.var matches ..-1 run scoreboard players operation $aetlas.pos.dz aetlas.var += $aetlas.random aetlas.var

# If no upper bound is specified and the lower bound is positive, the offset is set to the specified lower bound
execute if score $aetlas.lower_bound aetlas.var matches 0.. run scoreboard players operation $aetlas.pos.dz aetlas.var += $aetlas.lower_bound aetlas.var