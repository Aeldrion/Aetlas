...
execute store result storage aetlas:stack Score[-1] int 1 run scoreboard players get $aetlas.tables aetlas.var
data modify storage aetlas:stack Score append value 0
execute store result storage aetlas:stack Score[-1] int 1 run scoreboard players get $aetlas.name_matches aetlas.var
...
execute if score $aetlas.name_matches aetlas.var matches 1 run function aetlas:table/entry/structure_table/call

execute store result score $aetlas.name_matches aetlas.var run data get storage aetlas:stack Score[-1]
data remove storage aetlas:stack Score[-1]
execute store result score $aetlas.tables aetlas.var run data get storage aetlas:stack Score[-1]
data remove storage aetlas:stack Score[-1]