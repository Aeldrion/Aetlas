...
# Apply functions (pos.y=-1 means the structure block's position wasn't yet modified by a set_height function)
scoreboard players set $aetlas.pos.y aetlas.var -1
...
summon minecraft:area_effect_cloud ~ ~ ~ {UUIDLeast:2L, UUIDMost:49101603096664772L, Tags: ["aetlas", "aetlas.structure_block_placer"]}
execute as 00ae71a5-da7a-9ac4-0000-000000000002 at @s run function aetlas:table/entry/structure/place_blocks
kill 00ae71a5-da7a-9ac4-0000-000000000002
